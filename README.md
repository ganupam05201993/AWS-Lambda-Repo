...
```bash
sam-app$ sam local invoke usrMigration --event events/event.json
```
...
## Add env variables to custom-messsages-lambdas  lambda
SUPPPORT_EMAIL
WAVE_URL

## Add env variables to user-migration-lambdas  lambda
MONGO_URL
